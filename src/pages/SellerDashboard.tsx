            ...
            {activeTab === 'dashboard' ? (
              ...
              <div className="bg-white rounded-xl border border-slate-100 p-20 text-center shadow-sm flex flex-col items-center">
                <div className="mb-6 flex flex-col items-center gap-4">
                  <img src={logo} alt="Oppas Haven" className="h-16 w-auto grayscale opacity-20" />
                  <span className="text-slate-200 font-serif text-[24px] font-medium italic">Oppas Haven</span>
                </div>
