      ...
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
        <div className="flex items-center gap-10">
          ...
          <Link to="/" className="flex items-center gap-3">
            <img src={logo} alt="Oppas Haven" className="h-10 md:h-11 w-auto object-contain" />
            {/* <span className="text-white font-serif text-[20px] font-bold hidden sm:block">Oppas Haven</span> */}
          </Link>
