            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    <motion.h2 
                        ...
                        className="text-[32px] md:text-[42px] lg:text-[48px] font-bold text-[#1a2e35] uppercase tracking-tight leading-[1.1] max-w-5xl mx-auto font-serif"
                    >
                        TURN YOUR LOVE FOR ANIMALS AND <br className="hidden md:block" /> 
                        TRAVEL INTO TRUSTED INCOME.
                    </motion.h2>
