...
const GetStartedCTA = () => {
  return (
    <section className="w-full bg-[#F7F6F2] pb-8 px-6">
      ...
      >
        {/* Heading */}
        <h2 className="text-[32px] md:text-[48px] font-serif font-medium text-white mb-6 leading-tight max-w-4xl mx-auto">
          Find a Trusted Sitter or Earn Money Caring for Pets & Homes.
        </h2>
